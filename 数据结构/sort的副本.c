...
void adjust(int k[],int i,int n)//堆排序
{
	int j,temp;
    temp=k[i];
    j=2*i+1;
...
void quick_sort(int k[],int l,int r)//快速排序
{
	int i,mid;
	if (l<r)
	{
