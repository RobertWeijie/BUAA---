    ...
    public Expr multsimplify() {
        ...
        for (Factor item : factors) {
            if (item instanceof Expr) {
                ...
                if (((Trifunction) item).getContent() instanceof Expr) {
                    Expr addsimplify11 = ((Expr) (((Trifunction) item).getContent())).addsimplify();
                    ((Trifunction) item).setContent(addsimplify11);
                }
