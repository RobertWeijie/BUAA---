...
//                throw new AssertionError();
    ...
    private void modifyRelationOKTest() {
        ...
        try {
            ...
            id1 = Integer.parseInt(cmdList.remove(0));
            id2 = Integer.parseInt(cmdList.remove(0));
            value = Integer.parseInt(cmdList.remove(0));
            afterData = getModifyRelationOKData(cmdList, false);
            Network tmpNetwork = (Network) this.networkConstructor.newInstance();
            int ret = tmpNetwork.modifyRelationOKTest(id1, id2, value, beforeData, afterData);
            if (ret == 0) {
                System.out.println("true");
            } else if (ret < 0) {
                System.out.println("false in exception");
            } else {
